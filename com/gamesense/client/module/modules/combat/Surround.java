...
public class Surround extends Module
{
    ...
    public Surround() {
        ...
        this.offsetMode = this.registerMode("Pattern", Arrays.asList("Normal", "Anti City"), "Normal");
    ...
    public void onEnable() {
        ...
        if (this.centerPlayer.getValue() && Surround.mc.field_71439_g.field_70122_E) {
            Surround.mc.field_71439_g.field_70159_w = 0.0;
            Surround.mc.field_71439_g.field_70179_y = 0.0;
        }
        this.centeredBlock = BlockUtil.getCenterOfBlock(Surround.mc.field_71439_g.field_70165_t, Surround.mc.field_71439_g.field_70163_u, Surround.mc.field_71439_g.field_70163_u);
        this.oldSlot = Surround.mc.field_71439_g.field_71071_by.field_70461_c;
    }
    ...
    public void onDisable() {
        ...
        if (this.outOfTargetBlock) {
            this.setDisabledMessage("No obsidian detected... Surround turned OFF!");
        }
        if (this.oldSlot != Surround.mc.field_71439_g.field_71071_by.field_70461_c && this.oldSlot != -1 && this.oldSlot != 9) {
            Surround.mc.field_71439_g.field_71071_by.field_70461_c = this.oldSlot;
            this.oldSlot = -1;
        }
        if (this.isSneaking) {
    ...
    public void onUpdate() {
        ...
        if (this.sneakOnly.getValue() && !Surround.mc.field_71439_g.func_70093_af()) {
            return;
        }
        if (!Surround.mc.field_71439_g.field_70122_E && !Surround.mc.field_71439_g.field_70134_J) {
        ...
        if (this.centerPlayer.getValue() && this.centeredBlock != Vec3d.field_186680_a && Surround.mc.field_71439_g.field_70122_E) {
        ...
        if (this.delayTimer.getTimePassed() / 50L >= this.delayTicks.getValue()) {
            ...
            while (blocksPlaced <= this.blocksPerTick.getValue()) {
                ...
                if (Surround.mc.field_71439_g.field_70163_u % 1.0 > 0.2) {
                    targetPos = new BlockPos(targetPos.func_177958_n(), targetPos.func_177956_o() + 1, targetPos.func_177952_p());
                }
                if (!Surround.mc.field_71441_e.func_180495_p(targetPos).func_185904_a().func_76222_j()) {
                    tryPlacing = false;
                }
                for (final Entity entity : Surround.mc.field_71441_e.func_72839_b((Entity)null, new AxisAlignedBB(targetPos))) {
    ...
    private boolean placeBlock(final BlockPos pos) {
        ...
        if (targetBlockSlot == 9) {
            this.activedOff = true;
            if (!(Surround.mc.field_71439_g.func_184592_cb().func_77973_b() instanceof ItemBlock) || !(((ItemBlock)Surround.mc.field_71439_g.func_184592_cb().func_77973_b()).func_179223_d() instanceof BlockObsidian)) {
                return false;
            }
            handSwing = EnumHand.OFF_HAND;
        }
        if (Surround.mc.field_71439_g.field_71071_by.field_70461_c != targetBlockSlot && targetBlockSlot != 9) {
            Surround.mc.field_71439_g.field_71071_by.field_70461_c = targetBlockSlot;
        }
