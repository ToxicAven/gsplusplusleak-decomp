...
public class ShulkerViewer extends Module
{
    ...
    public void renderShulkerPreview(final ItemStack itemStack, final int posX, final int posY, final int width, final int height) {
        ...
        FontUtil.drawStringWithShadow(ModuleManager.getModule(ColorMain.class).customFont.getValue(), itemStack.func_82833_r(), posX + 3, posY + 3, new GSColor(255, 255, 255, 255));
        ...
        ItemStackHelper.func_191283_b(itemStack.func_77978_p().func_74775_l("BlockEntityTag"), (NonNullList)contentItems);
